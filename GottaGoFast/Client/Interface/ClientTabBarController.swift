...
class ClientTabBarController: UITabBarController {
  ...
  override func viewDidLoad() {
    ...
    let mainVC = ClientMainViewController(nibName:"ClientMainViewController", bundle: .main)
    ...
    let profileVC = ClientProfileViewController(nibName:"ClientProfileViewController", bundle: .main)
